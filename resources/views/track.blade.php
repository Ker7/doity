                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="number" step="any" width=8 /> <span id="form-track-unit-name"></span>
                            
                        </div>
                        <div class="col-sm-4">
                        
                            {{ Form::date('kuupaev', \Carbon\Carbon::now()->timezone('Europe/Tallinn')) }}
                            {{ Form::time('aeg', $nowTime) }}
                            {{-- $nowTime --}}
                    ...
                    <div class="row">
                        <div class="col-sm-4"><h5>Tags ::</h5><span id="form-track-tags"></span></div>
